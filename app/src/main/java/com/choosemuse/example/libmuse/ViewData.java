...
public class ViewData extends Activity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    WeakReference<ViewData> weakActivity =
      new WeakReference<ViewData>(this);
  ...
  class MuseL extends MuseListener {
    final WeakReference<ViewData> activityRef;

    MuseL(final WeakReference<ViewData> activityRef) {
  ...
  class ConnectionListener extends MuseConnectionListener {
    ...
    ConnectionListener(final WeakReference<ViewData> activityRef) {
      this.activityRef = activityRef;
    }
  ...
  class DataListener extends MuseDataListener {
    ...
    DataListener(final WeakReference<ViewData> activityRef) {
      this.activityRef = activityRef;
    }
